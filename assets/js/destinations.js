...
const DestinationsModule = (() => {
    ...
    const generateMockDestinations = (count, type) => {
        const regions = {
            global: ['Paris', 'Tokyo', 'New York', 'London', 'Sydney', 'Rome', 'Barcelona', 'Bali', 'Dubai', 'Singapore'],
            europe: ['Paris', 'Rome', 'Barcelona', 'Amsterdam', 'Santorini', 'Prague', 'Venice', 'Edinburgh', 'Copenhagen', 'Athens'],
            asia: ['Tokyo', 'Bangkok', 'Bali', 'Seoul', 'Singapore', 'Hong Kong', 'Kyoto', 'Hanoi', 'Shanghai', 'Mumbai'],
            americas: ['New York', 'Cancun', 'Rio de Janeiro', 'Vancouver', 'Machu Picchu', 'Los Angeles', 'Miami', 'Toronto', 'Buenos Aires', 'Chicago']
        };
        ...
        return Array.from({ length: count }, (_, i) => {
            ...
            const trend = type === 'trending' ? ['up', 'down', 'neutral'][Math.floor(Math.random() * 3)] : null;
            ...
            return {
                ...
                tags: ['cultural', 'beach', 'mountain', 'city', 'historic'][Math.floor(Math.random() * 5)],
